...
## Q1: Collect state-action observations for 1000 episodes
transitions = []
...
print("\nExample: From state 0, action 0:")
print(f"Transition probabilities to next states: {T_estimated[0, 0, :]}")
...
def value_iteration(T, R, gamma=0.9, theta=1e-6):
...
print(f"Success rate: {successful_episodes / num_episodes * 100:.2f}%")
print(f"Average reward: {total_reward / num_episodes:.4f}")